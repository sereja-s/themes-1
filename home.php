...
<!-- в админке необходимо для этой страницы также выбрать шаблон по имени Home -->
...
<!-- содержимое копируем из файла index.php: -->
				...
				<div class="services__content-box">
					...
					<div class="services__content-textbox">
						<p class="services__content-text">
							...
							теряет
							половину цены даже
							из-за минимальных повреждений. Если учитывать денежные затраты, а именно выкуп, доставку,
							таможню и
							ремонт, то цена
							аналогичного по состоянию автомобиля в Украине будет выше на 35-50%, а новые будут стоить
							космических
							денег.
						</p>
					</div>					

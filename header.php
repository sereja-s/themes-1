...
<head>
	...
	<!-- Подключаем стили из файла function.php -->
	<?php wp_head(); ?>
	...
	<header class="header">
		<div class="container">
			<div class="header__top">
				...
				<a class="phone" href="tel:+380555556677">+38 (055) 555 66 77</a>
			</div>
			<div class="header__content">
				...
				<img data-wow-delay="2s" class="header__images wow animate__fadeInUpBig" src="<?php bloginfo('template_url'); ?>/assets/images/ford-mustang.png" alt="ford mustang">
			</div>
		</div>
	</header>